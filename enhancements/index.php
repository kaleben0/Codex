...
<body id="switch2">
    ...
    <div class="training">
        ...
        <div class="enhance_body_display">
            ...
            <div class="enhance_display_menu endurance_modification" onclick="toggleendurance_modification()"><img
                    src="./images/training/TO-Training-Endurance-Modification.png">
